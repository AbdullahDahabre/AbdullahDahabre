...
Artificial Intelligence Engineer specializing in **AI agents, LLM-based systems, and end-to-end AI applications**. Experienced in designing, building, and deploying complete AI-driven products, with a strong focus on automation, scalability, and real-world impact. Continuously exploring the latest research, tools, and technologies in AI.
...
* **Bachelor’s Degree in Artificial Intelligence Engineering**
  [Bahcesehir University](https://www.bau.edu.tr) — *2021 - 2025*
